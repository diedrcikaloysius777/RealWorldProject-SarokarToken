...
Sarokar is built upon the fundamentals of Buyback and increasing the investor's value
...
contract Sarokar is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB87A6B7Ed42a331cc4BA85Df42063668cDFE405f); // Marketing Address
    ...
    string private _name = "Sarokar";
    string private _symbol = "SAROKAR";
    ...
    uint256 private minimumTokensBeforeSwap = 4000 * 10**18; 
